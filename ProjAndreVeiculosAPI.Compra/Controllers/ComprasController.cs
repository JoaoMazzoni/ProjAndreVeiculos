...
namespace ProjAndreVeiculosAPICompra.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ComprasController : ControllerBase
    {
        private readonly ProjAndreVeiculosAPICompraContext _context;

        public ComprasController(ProjAndreVeiculosAPICompraContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Compra>> PostCompra(Compra compra)
        {
          if (_context.Compra == null)
          {
              return Problem("Entity set 'ProjAndreVeiculosAPICompraContext.Compra'  is null.");
          }
