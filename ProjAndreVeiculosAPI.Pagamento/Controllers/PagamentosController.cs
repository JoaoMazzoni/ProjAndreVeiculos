...
namespace ProjAndreVeiculosAPIPagamento.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class PagamentosController : ControllerBase
    {
        private readonly ProjAndreVeiculosAPIPagamentoContext _context;

        public PagamentosController(ProjAndreVeiculosAPIPagamentoContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Pagamento>> PostPagamento(Pagamento pagamento)
        {
          if (_context.Pagamento == null)
          {
              return Problem("Entity set 'ProjAndreVeiculosAPIPagamentoContext.Pagamento'  is null.");
          }
