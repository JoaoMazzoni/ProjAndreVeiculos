...
namespace ProjAndreVeiculosAPIServico.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ServicosController : ControllerBase
    {
        private readonly ProjAndreVeiculosAPIServicoContext _context;

        public ServicosController(ProjAndreVeiculosAPIServicoContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Servico>> PostServico(Servico servico)
        {
          if (_context.Servico == null)
          {
              return Problem("Entity set 'ProjAndreVeiculosAPIServicoContext.Servico'  is null.");
          }
